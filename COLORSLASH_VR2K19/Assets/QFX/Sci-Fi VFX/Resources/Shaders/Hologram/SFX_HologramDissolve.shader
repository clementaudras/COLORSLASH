...
Shader "QFX/SFX/Hologram/HologramDissolve"
{
	...
	SubShader
	{
		...
		{
			float4 transform24_g40 = mul(unity_ObjectToWorld,float4( 0,0,0,1 ));
			float3 ase_worldPos = i.worldPos;
			float3 ase_objectScale = float3( length( unity_ObjectToWorld[ 0 ].xyz ), length( unity_ObjectToWorld[ 1 ].xyz ), length( unity_ObjectToWorld[ 2 ].xyz ) );
			float4 temp_output_7_0_g40 = ( ( lerp(( transform24_g40 - float4( ase_worldPos , 0.0 ) ),( float4( ase_worldPos , 0.0 ) - transform24_g40 ),_MaskAppearInvert) / float4( ase_objectScale , 0.0 ) ) + ( _MaskAppearProgress + 0.0 ) );
			float4 break5_g40 = temp_output_7_0_g40;
			float4 temp_cast_3 = (break5_g40.y).xxxx;
			float4 temp_cast_7 = (break5_g40.x).xxxx;
			float4 temp_cast_8 = (break5_g40.y).xxxx;
			float4 temp_cast_9 = (break5_g40.z).xxxx;
			#if defined(_MASKAPPEARAXIS_NONE)
				float4 staticSwitch6_g40 = temp_output_7_0_g40;
			#elif defined(_MASKAPPEARAXIS_X)
				float4 staticSwitch6_g40 = temp_cast_7;
			#elif defined(_MASKAPPEARAXIS_Y)
				float4 staticSwitch6_g40 = temp_cast_3;
			#elif defined(_MASKAPPEARAXIS_Z)
				float4 staticSwitch6_g40 = temp_cast_9;
			#else
				float4 staticSwitch6_g40 = temp_cast_3;
			#endif
			float4 temp_cast_10 = (0.0).xxxx;
			float smoothstepResult31_g40 = smoothstep( 0.0 , _MaskAppearStrength , ( staticSwitch6_g40 - temp_cast_10 ).x);
			float temp_output_17_0_g39 = smoothstepResult31_g40;
			float mask_appear6_g39 = temp_output_17_0_g39;
			...
			float4 dissolve_color5_g39 = ( _DissolveColor * temp_output_17_0_g39 );
			o.Emission = (( mask_appear6_g39 > _DissolveAmount ) ? lerpResult175 :  dissolve_color5_g39 ).rgb;
			float2 temp_cast_13 = (_Scan).xx;
			float2 Scan35 = step( frac( ( ( _ScanTiling * ase_worldPos.y ) + ( _Time.y * _ScanSpeed ) ) ) , temp_cast_13 );
...
/*ASEBEGIN
Version=15600
215;428;1412;619;322.6335;-589.1331;1.727425;False;False
...
Node;AmplifyShaderEditor.GetLocalVarNode;61;-63.60762,450.9254;Float;False;219;glow_val;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;38;-63.26923,370.7632;Float;False;35;Scan;0;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;68;-821.6207,715.4508;Float;True;Property;_FlickerTexture;Flicker Texture;9;0;Create;True;0;0;False;0;None;9d903017bd4bd344e976cdb4cf902b6d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;73;327.664,522.4269;Float;False;72;Flicker;0;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;131;-338.5438,-547.3767;Float;True;Property;_EmissionTexture;Emission Texture;2;0;Create;True;0;0;False;0;None;9833aab57bc26d64fbac696212133142;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;132;-254.7276,-346.4791;Float;False;Property;_EmissionColor;Emission Color;1;1;[HDR];Create;True;0;0;False;0;0,0,0,0;1,0.2352933,0.2352933,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;209;-1405.988,1081.449;Float;False;Property;_GlowColor;Glow Color;4;1;[HDR];Create;True;0;0;False;0;0,0,0,0;0.3455874,0.5125748,1,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;173;406.0053,1324.265;Float;False;172;fresnel_val;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;150;476.6146,1182.349;Float;False;149;Opacity;0;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;166;-338.0693,-8.384624;Float;False;Property;_FresnelColor;Fresnel Color;11;1;[HDR];Create;True;0;0;False;0;1,1,1,1;2.123126,0.110293,3.000003,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;226;68.35352,863.4203;Float;False;219;glow_val;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;176;395.4203,1095.274;Float;False;172;fresnel_val;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;225;53.35352,782.4203;Float;False;211;glow_colorg;0;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;224;77.35352,703.4203;Float;False;134;emission;0;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;18;549.2241,969.6487;Float;False;8;fresnel_color;0;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;88;1332.299,1381.479;Float;False;87;VertexOffset;0;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;277;1214.079,984.5399;Float;False;QFX Get Simple Dissolve;23;;39;614d23a5ed725f9478c6a2f099c21623;0;1;10;COLOR;0,0,0,0;False;2;COLOR;0;FLOAT;12
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;129;1680.799,992.8266;Float;False;True;2;Float;ASEMaterialInspector;0;0;Unlit;QFX/SFX/Hologram/HologramDissolve;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;False;0;True;TransparentCutout;;Transparent;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;False;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;0;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;277;10;175;0
WireConnection;129;2;277;0
WireConnection;129;9;243;0
WireConnection;129;10;277;12
WireConnection;129;11;88;0
ASEEND*/
//CHKSM=DC09F713E98363183304AFEAD9A4F9DA3F38563A